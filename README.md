...
* [`sfdx ftw:init -s <string> [-r <string>] [-v <string>] [-u <string>] [--apiversion <string>] [--json] [--loglevel trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]`](#sfdx-ftwinit--s-string--r-string--v-string--u-string---apiversion-string---json---loglevel-tracedebuginfowarnerrorfataltracedebuginfowarnerrorfatal)
...
## `sfdx ftw:init -s <string> [-r <string>] [-v <string>] [-u <string>] [--apiversion <string>] [--json] [--loglevel trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]`

Initialize a new assertion suite

```
USAGE
  $ sfdx ftw:init -s <string> [-r <string>] [-v <string>] [-u <string>] [--apiversion <string>] [--json] [--loglevel 
  trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]

OPTIONS
  -r, --remote=remote                                                               Remote repo. Overrides
                                                                                    "defaultremote" repo from config
                                                                                    file.

  -s, --suite=suite                                                                 (required) Name of the assertion
                                                                                    suite.
...
_See code: [lib/commands/ftw/init.js](https://github.com/alpha-bytes/sfdx-ftw/blob/v0.1.1/lib/commands/ftw/init.js)_
<!-- commandsstop -->
